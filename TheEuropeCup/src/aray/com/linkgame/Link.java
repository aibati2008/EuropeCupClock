...
public class Link extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.linkgame);
		setTitle("欧洲杯连连看");
		// 初始化界面
		init();
	}
	...
	// 初始化游戏的方法
	private void init() {
		config = new GameConf(9, 10, 0, 0, 100000, this);
		// 得到游戏区域对象
		...
		this.gameView.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View view, MotionEvent e) {
				if (isPlaying = false) {
					new AlertDialog.Builder(Link.this).setMessage("请点击开始！")
	...
	private void gameViewTouchDown(MotionEvent event) {
		...
		Log.d("DEBUG", "getX=" + touchX + "getY=" + touchY);
